<%--
    Document   : cloud
    Created on : Nov 10, 2016, 4:21:49 PM
    Author     : java4
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="main">
            ...
            <div class="content">
                <div class="content_resize"> <img src="images/slide4.jpg" width="958" height="245" alt="" class="hbg_img" />
                    <div class="mainbar">
                        <div class="article">
                            <!--- Start Body ------>

                            <br><center><font style="font-family: fantasy; font-size: x-large; color: #595959; font-style: inherit">CLOUD LOGIN</font><br>
